...
class Config:
    def __init__(self):
        ...
        self.site_config = config_data.get('site_config', {})
        self.openai_key = os.getenv("OPENAI_API_KEY") or config_data.get('openai_key')
        ...
        self.debug = os.getenv('DEBUG', '').lower() == 'true' or self.site_config.get('debug', False)
